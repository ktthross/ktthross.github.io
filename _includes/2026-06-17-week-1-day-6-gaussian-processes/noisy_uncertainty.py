...
for noise_std in (0.05, 0.2, 1.0):
    k_train_train_stable = k_train_train + noise_std ** 2 * np.eye(len(x_train))
    ...
    assets = os.path.join(os.path.dirname(__file__), "../../assets/2026_06_17_week_1_day_6_gaussian_processes")
    ...
    plt.figure()
    draw_plot()
    plt.savefig(os.path.join(assets, f"posterior_noise_{noise_std}.png"), dpi=150, bbox_inches="tight")
